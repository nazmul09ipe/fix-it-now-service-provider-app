        ...
        >
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                123 Repair Street, Dhaka, Bangladesh
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="form-control">
            ...
            <input
              ...
              className="input input-bordered w-full bg-white dark:bg-gray-900 focus:ring-2 focus:ring-primary"
              required
            />
          </div>
          ...
          <div className="form-control">
            ...
            <textarea
              ...
              onChange={handleChange}
              className="textarea textarea-bordered w-full bg-white dark:bg-gray-900 focus:ring-2 focus:ring-primary"
              required
            ></textarea>
          </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            type="submit"
            className="btn btn-primary w-full mt-4 text-lg font-semibold tracking-wide shadow-md"
          >
            Send Message
          </motion.button>
        </motion.form>
