      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900 rounded-3xl shadow-xl p-8 sm:p-10 space-y-8 transition-colors duration-500">
        ...
        <section className="text-center">
          ...
          <p className="text-left text-gray-700 dark:text-gray-300">
            By accessing or using FixItNow (the “Website”), you agree to be
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            FixItNow is a platform that helps users discover and book repair and maintenance services
        ...
        <section>
          ...
          <ul className="list-disc list-inside ml-4 space-y-1 text-gray-700 dark:text-gray-300">
            <li>You must be at least 13 years old to use FixItNow.</li>
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">If FixItNow allows users to create accounts:</p>
          <ul className="list-disc list-inside ml-4 space-y-1 text-gray-700 dark:text-gray-300">
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            Services listed on FixItNow are provided for informational purposes.
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            FixItNow may include links to third-party websites or platforms.
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            All content on FixItNow, including logos, design, and text, is owned or licensed by us.
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            To the fullest extent allowed by law, FixItNow is provided “as is” without warranties of any kind.
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            We reserve the right to suspend or terminate your access to FixItNow at any time
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            ...
            Continued use of FixItNow after changes means you accept the updated Terms.
          </p>
        </section>
