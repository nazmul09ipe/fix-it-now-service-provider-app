        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 -mt-1">
              Your One Stop Solution to Every Day Fixes
            </p>
          </div>
        </div>
                ...
                <AnimatePresence>
                  {showDashboardMenu && (
                    <motion.ul
                      ...
                      className="absolute mt-3 w-56 bg-white dark:bg-gray-800 border 
                      border-gray-200 dark:border-gray-700 rounded-xl shadow-xl py-2 z-[999]"
                    >
                      {[
                        { path: "/dashboard/addService", label: "Add Service" },
                        { path: "/dashboard/manageServices", label: "Manage Services" },
                        { path: "/dashboard/bookedServices", label: "Booked Services" },
                        { path: "/dashboard/serviceToDo", label: "Service To Do" },
                      ].map(({ path, label }) => (
                        <li
                          key={path}
